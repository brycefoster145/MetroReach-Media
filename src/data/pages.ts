...
export const subServices = [
  ...
  { slug: "hashtag-research", category: "organic-content", name: "Hashtag Research", description: "Data-driven hashtag strategy built from competitor analysis, industry trends, and audience behavior.", price: "$300", pipelineStatus: "building" },
  ...
  { slug: "dm-management", category: "organic-content", name: "DM Management", description: "Prompt, on-brand responses to direct messages that turn inquiries into conversations and conversations into leads.", price: "From $400/month", pipelineStatus: "building" },
  ...
  { slug: "audience-research", category: "social-strategy", name: "Audience Research", description: "Deep audience analysis — demographics, behaviors, content preferences, and platform usage patterns.", price: "From $600", pipelineStatus: "building" },
  { slug: "organic-growth-strategy", category: "social-strategy", name: "Organic Growth Strategy", description: "A sustainable organic growth plan focused on content quality, community building, and platform-native tactics.", price: "From $700/month", pipelineStatus: "building" },
  ...
  // Analytics & Reporting
  { slug: "monthly-performance-reports", category: "analytics-reporting", name: "Monthly Performance Reports", description: "Comprehensive monthly reports covering all key metrics — CPL, ROAS, engagement, reach, and attribution.", price: "From $500/month", pipelineStatus: "building" },
  { slug: "weekly-performance-summaries", category: "analytics-reporting", name: "Weekly Performance Summaries", description: "Concise weekly summaries highlighting what's working, what's shifting, and what needs attention.", price: "From $350/month", pipelineStatus: "building" },
  { slug: "kpi-dashboard-setup", category: "analytics-reporting", name: "KPI Dashboard Setup", description: "Live dashboard configured with your key metrics — visible anytime, no waiting for monthly reports.", price: "$750", pipelineStatus: "building" },
  { slug: "executive-reports", category: "analytics-reporting", name: "Executive Reports", description: "High-level reports designed for leadership — clear insights, trends, and ROI analysis without the noise.", price: "From $600/month", pipelineStatus: "building" },
  { slug: "competitor-benchmarking", category: "analytics-reporting", name: "Competitor Benchmarking", description: "See how your performance stacks up against competitors with clear benchmarking across key metrics.", price: "From $500/month", pipelineStatus: "building" },

  // Community Management
  { slug: "daily-monitoring-engagement", category: "community-management", name: "Daily Monitoring & Engagement", description: "Every comment, mention, and message monitored and responded to daily — nothing slips through.", price: "From $600/month", pipelineStatus: "building" },
  { slug: "comment-dm-response", category: "community-management", name: "Comment & DM Response", description: "Prompt, professional responses to comments and DMs that build relationships and protect your brand reputation.", price: "From $400/month", pipelineStatus: "building" },
  { slug: "review-management", category: "community-management", name: "Review Management", description: "Monitor and respond to reviews across platforms — turn feedback into trust signals for potential customers.", price: "From $350/month", pipelineStatus: "building" },
  { slug: "social-listening-community", category: "community-management", name: "Social Listening", description: "Monitor brand mentions, industry conversations, and competitor activity to surface opportunities and risks.", price: "From $500/month", pipelineStatus: "building" },
  { slug: "influencer-research", category: "community-management", name: "Influencer Research", description: "Identify and evaluate potential influencer partners aligned with your brand, audience, and campaign goals.", price: "From $750/month", pipelineStatus: "building" },
  { slug: "community-engagement-templates", category: "community-management", name: "Community Engagement Templates", description: "Ready-to-use response templates for common interactions — maintaining brand voice while saving time.", price: "$300", pipelineStatus: "building" },
];
