...
export const subServices = [
  ...
  { slug: "ad-account-setup", category: "paid-advertising", name: "Ad Account Setup", description: "We will configure your ad accounts for proper tracking, structure, and compliance. This ensures your campaigns run smoothly and deliver accurate data.", price: "$500 one-time", pipelineStatus: "verified" },
  { slug: "ad-creative-package", category: "paid-advertising", name: "Ad Creative Package", description: "We will design high‑performing ad creatives that capture attention and drive conversions. Every creative will be built to match your brand and maximize ROI.", price: "From $750/month", pipelineStatus: "verified" },
  { slug: "ab-testing-optimization", category: "paid-advertising", name: "A/B Testing & Optimization", description: "We will run systematic tests to identify winning creatives, audiences, and placements. This ensures your ad spend is used efficiently and effectively.", price: "From $500/month", pipelineStatus: "verified" },
  { slug: "pixel-conversion-tracking", category: "paid-advertising", name: "Pixel & Conversion Tracking", description: "We will set up accurate tracking systems to measure performance and optimize campaigns. This gives you clear insight into what's working and what needs improvement.", price: "$400 one-time", pipelineStatus: "verified" },
  { slug: "landing-page-review", category: "paid-advertising", name: "Landing Page Review", description: "We will analyze your landing pages to improve clarity, trust, and conversion rates. This ensures your ads lead to pages that actually drive results.", price: "$350 one-time", pipelineStatus: "verified" },
  ...
  // Analytics & Reporting
  { slug: "monthly-performance-reports", category: "analytics-reporting", name: "Monthly Performance Reports", description: "We will deliver detailed monthly reports that highlight trends, wins, and opportunities. This gives you a clear understanding of your growth and performance.", price: "From $500/month", pipelineStatus: "verified" },
  { slug: "weekly-performance-summaries", category: "analytics-reporting", name: "Weekly Performance Summaries", description: "We will send concise weekly updates that keep you informed and aligned. This ensures you always know how your content is performing.", price: "From $350/month", pipelineStatus: "verified" },
  { slug: "kpi-dashboard-setup", category: "analytics-reporting", name: "KPI Dashboard Setup", description: "We will build a custom dashboard showing your most important metrics in real time. This helps you make smarter, faster decisions.", price: "$750 one-time", pipelineStatus: "verified" },
  { slug: "executive-reports", category: "analytics-reporting", name: "Executive Reports", description: "We will create high‑level reports designed for leadership and decision‑makers. These reports highlight strategic insights and business impact.", price: "From $600/month", pipelineStatus: "verified" },
  ...
  { slug: "influencer-research", category: "community-management", name: "Influencer Research", description: "We will identify influencers aligned with your brand for future collaborations. This helps you expand reach and credibility.", price: "From $750/month", pipelineStatus: "verified" },
  { slug: "community-engagement-templates", category: "community-management", name: "Community Engagement Templates", description: "We will create pre‑built engagement templates to streamline communication. This ensures consistent, professional interactions.", price: "$300 one-time", pipelineStatus: "verified" },
  ...
  { slug: "social-inbox-design", category: "community-management", name: "Social Inbox Design", description: "We will design a structured, optimized inbox layout that improves workflow and response efficiency. This helps your team stay organized and effective.", price: "From $600 one-time", pipelineStatus: "verified" },
];
