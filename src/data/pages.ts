...
export const subServices = [
  // Organic Content Management
  { slug: "social-media-audit", category: "organic-content", name: "Social Media Audit", description: "We analyze your entire social media presence to identify strengths, weaknesses, and growth opportunities. You receive a clear, actionable plan to improve reach, engagement, and brand consistency.", price: "$500 one-time", pipelineStatus: "verified" },
