...
export const subServices = [
  ...
  { slug: "dm-management", category: "organic-content", name: "DM Management", description: "Prompt, on-brand responses to direct messages that turn inquiries into conversations and conversations into leads.", price: "From $400/month", pipelineStatus: "coming-soon" },
  ...
  // Paid Advertising
  { slug: "meta-ads-management", category: "paid-advertising", name: "Meta Ads Management", description: "Full campaign management across Facebook and Instagram — audience targeting, creative, bidding, and continuous optimization.", price: "From $1,000/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "ad-account-setup", category: "paid-advertising", name: "Ad Account Setup", description: "Professional configuration of your ad accounts, pixels, conversion tracking, and audience foundations.", price: "$500 one-time", pipelineStatus: "coming-soon" },
  { slug: "ad-creative-package", category: "paid-advertising", name: "Ad Creative Package", description: "High-converting ad creative — static, carousel, and video concepts — designed and tested for performance.", price: "From $750/month", pipelineStatus: "coming-soon" },
  { slug: "ab-testing-optimization", category: "paid-advertising", name: "A/B Testing & Optimization", description: "Systematic testing of creative, audiences, landing pages, and bids to continuously improve campaign performance.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "pixel-conversion-tracking", category: "paid-advertising", name: "Pixel & Conversion Tracking", description: "Accurate tracking setup so you know exactly which ads are driving leads and revenue.", price: "$400 one-time", pipelineStatus: "coming-soon" },
  { slug: "landing-page-review", category: "paid-advertising", name: "Landing Page Review", description: "Expert review of your landing pages with actionable recommendations to improve conversion rates.", price: "$350 one-time", pipelineStatus: "coming-soon" },
  { slug: "google-ads-management", category: "paid-advertising", name: "Google Ads Management", description: "Full campaign management across Google Search, Display, YouTube, and Performance Max. Strategy, build, optimization, and reporting.", price: "From $1,000/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "tiktok-ads-management", category: "paid-advertising", name: "TikTok Ads Management", description: "Creative-first TikTok ad campaigns — Spark Ads, In-Feed, and TopView. Strategy and creative direction for the platform that rewards authenticity.", price: "From $1,200/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "linkedin-ads-management", category: "paid-advertising", name: "LinkedIn Ads Management", description: "B2B ad campaigns — Sponsored Content, Message Ads, and Lead Gen Forms. Targeting by job title, industry, company size, and seniority.", price: "From $1,200/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "x-ads-management", category: "paid-advertising", name: "X (Twitter) Ads Management", description: "Promoted posts, Follower campaigns, and Trend Takeovers. Real-time engagement and conversation-driven advertising.", price: "From $1,000/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "youtube-ads-management", category: "paid-advertising", name: "YouTube Ads Management", description: "Pre-roll, mid-roll, and discovery ads. Creative direction, audience targeting, and campaign optimization for the world's second-largest search engine.", price: "From $1,200/month + 10% ad spend", pipelineStatus: "coming-soon" },
  ...
  // Analytics & Reporting
  { slug: "monthly-performance-reports", category: "analytics-reporting", name: "Monthly Performance Reports", description: "Comprehensive monthly reports covering all key metrics — CPL, ROAS, engagement, reach, and attribution.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "weekly-performance-summaries", category: "analytics-reporting", name: "Weekly Performance Summaries", description: "Concise weekly summaries highlighting what's working, what's shifting, and what needs attention.", price: "From $350/month", pipelineStatus: "coming-soon" },
  { slug: "kpi-dashboard-setup", category: "analytics-reporting", name: "KPI Dashboard Setup", description: "Live dashboard configured with your key metrics — visible anytime, no waiting for monthly reports.", price: "$750 one-time", pipelineStatus: "coming-soon" },
  { slug: "executive-reports", category: "analytics-reporting", name: "Executive Reports", description: "High-level reports designed for leadership — clear insights, trends, and ROI analysis without the noise.", price: "From $600/month", pipelineStatus: "coming-soon" },
  { slug: "competitor-benchmarking", category: "analytics-reporting", name: "Competitor Benchmarking", description: "See how your performance stacks up against competitors with clear benchmarking across key metrics.", price: "From $500/month", pipelineStatus: "coming-soon" },

  // Community Management
  { slug: "community-management", category: "community-management", name: "Community Management", description: "Full-service community management — daily monitoring, engagement, review response, and reputation protection across all platforms.", price: "From $1,200/month", pipelineStatus: "coming-soon" },
  { slug: "daily-monitoring-engagement", category: "community-management", name: "Daily Monitoring & Engagement", description: "Every comment, mention, and message monitored and responded to daily — nothing slips through.", price: "From $600/month", pipelineStatus: "coming-soon" },
  { slug: "comment-dm-response", category: "community-management", name: "Comment & DM Response", description: "Prompt, professional responses to comments and DMs that build relationships and protect your brand reputation.", price: "From $400/month", pipelineStatus: "coming-soon" },
  { slug: "review-management", category: "community-management", name: "Review Management", description: "Monitor and respond to reviews across platforms — turn feedback into trust signals for potential customers.", price: "From $350/month", pipelineStatus: "coming-soon" },
  { slug: "social-listening-community", category: "community-management", name: "Social Listening", description: "Monitor brand mentions, industry conversations, and competitor activity to surface opportunities and risks.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "influencer-research", category: "community-management", name: "Influencer Research", description: "Identify and evaluate potential influencer partners aligned with your brand, audience, and campaign goals.", price: "From $750/month", pipelineStatus: "coming-soon" },
  { slug: "community-engagement-templates", category: "community-management", name: "Community Engagement Templates", description: "Ready-to-use response templates for common interactions — maintaining brand voice while saving time.", price: "$300 one-time", pipelineStatus: "coming-soon" },
  { slug: "platform-setup-community", category: "community-management", name: "Platform Setup & Optimization", description: "Professional setup and optimization of business profiles — bios, highlights, links, and settings configured for maximum discoverability.", price: "From $750 one-time", pipelineStatus: "coming-soon" },
  { slug: "social-inbox-management", category: "community-management", name: "Social Inbox Management", description: "Unified inbox management across all platforms — never miss a comment, DM, review, or mention again.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "social-inbox-design", category: "community-management", name: "Social Inbox Design", description: "Custom-designed inbox workflows, response templates, and escalation paths tailored to your brand voice and team structure.", price: "From $600 one-time", pipelineStatus: "coming-soon" },
];
