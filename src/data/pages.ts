...
export const subServices = [
  // Organic Content Management
  { slug: "social-media-audit", category: "organic-content", name: "Social Media Audit", description: "We analyze your entire social media presence to identify strengths, weaknesses, and growth opportunities. You receive a clear, strategic roadmap for improving reach, engagement, and brand consistency.", price: "$500 one-time", pipelineStatus: "verified" },
  { slug: "monthly-content-calendar", category: "organic-content", name: "Monthly Content Calendar", description: description: "Your content is organized into a strategic, easy‑to‑follow calendar that ensures consistent posting. Every piece is planned to support your brand goals and maximize audience engagement.", price: "From $1,000/month", pipelineStatus: "verified" },
  { slug: "caption-writing", category: "organic-content", name: "Caption Writing", description: description: "We craft compelling, on‑brand captions that increase engagement and communicate your message clearly. Each caption strengthens your brand voice and encourages meaningful interaction.", price: "From $750/month", pipelineStatus: "verified" },
  { slug: "hashtag-research", category: "organic-content", name: "Hashtag Research", description: description: "We build targeted hashtag sets designed to increase discoverability and reach the right audience. This improves visibility and helps your content perform better organically.", price: "$300 one-time", pipelineStatus: "verified" },
  { slug: "brand-voice-development", category: "organic-content", name: "Brand Voice Development", description: description: "We define a clear, consistent brand voice that makes your content instantly recognizable. This strengthens trust and creates a unified identity across all platforms.", price: "From $500 one-time", pipelineStatus: "verified" },
  { slug: "posting-schedule-optimization", category: "organic-content", name: "Posting Schedule Optimization", description: description: "We optimize your posting times based on audience behavior and platform data. This ensures your content reaches more people and performs better.", price: "From $400/month", pipelineStatus: "verified" },
  { slug: "trend-research", category: "organic-content", name: "Trend Research", description: description: "We monitor emerging trends to identify timely content opportunities. This keeps your brand relevant and increases your chances of going viral.", price: "From $350/month", pipelineStatus: "verified" },
  { slug: "daily-engagement", category: "organic-content", name: "Daily Engagement", description: description: "We interact with your audience daily to boost activity and strengthen relationships. This improves algorithm performance and builds a more loyal community.", price: "From $600/month", pipelineStatus: "verified" },
  { slug: "dm-management", category: "organic-content", name: "DM Management", description: description: "We will manage your inbox with fast, professional responses that improve customer experience and capture more leads. This service will unlock once workflow and staffing systems are finalized.", price: "From $400/month", pipelineStatus: "coming-soon" },
  { slug: "social-listening", category: "organic-content", name: "Social Listening", description: description: "We track conversations around your brand and industry to identify opportunities, feedback, and potential issues. This helps you stay ahead of trends and respond strategically.", price: "From $500/month", pipelineStatus: "verified" },
  { slug: "single-platform-management", category: "organic-content", name: "Single-Platform Management", description: description: "We fully manage one social platform — content, posting, engagement, and optimization. This gives you a polished, consistent presence without any extra work.", price: "From $800/month", pipelineStatus: "verified" },
  { slug: "multi-platform-management", category: "organic-content", name: "Multi-Platform Management — 5 Platforms", description: description: "We manage up to five platforms simultaneously to maximize reach and brand impact. Your content stays consistent, professional, and aligned across every channel.", price: "From $2,000/month", pipelineStatus: "verified" },
  { slug: "platform-setup-optimization", category: "organic-content", name: "Platform Setup & Optimization", description: description: "We professionally set up and optimize your social profiles for clarity, trust, and discoverability. This ensures your brand makes a strong first impression.", price: "From $750 one-time", pipelineStatus: "verified" },
  { slug: "profile-bio-optimization", category: "organic-content", name: "Profile/Bio Optimization", description: description: "We refine your profile and bio to communicate your value clearly and attract the right audience. This increases conversions and strengthens brand positioning.", price: "$400 one-time", pipelineStatus: "verified" },

  // Paid Advertising
  { slug: "meta-ads-management", category: "paid-advertising", name: "Meta Ads Management", description: description: "We will create and optimize Meta ad campaigns designed to increase visibility, generate leads, and deliver measurable results. This service unlocks once client ad accounts and credentials are fully established.", price: "From $1,000/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "ad-account-setup", category: "paid-advertising", name: "Ad Account Setup", description: description: "We will configure your ad accounts for proper tracking, structure, and compliance. This ensures your campaigns run smoothly and deliver accurate data.", price: "$500 one-time", pipelineStatus: "coming-soon" },
  { slug: "ad-creative-package", category: "paid-advertising", name: "Ad Creative Package", description: description: "We will design high‑performing ad creatives that capture attention and drive conversions. Every creative will be built to match your brand and maximize ROI.", price: "From $750/month", pipelineStatus: "coming-soon" },
  { slug: "ab-testing-optimization", category: "paid-advertising", name: "A/B Testing & Optimization", description: description: "We will run systematic tests to identify winning creatives, audiences, and placements. This ensures your ad spend is used efficiently and effectively.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "pixel-conversion-tracking", category: "paid-advertising", name: "Pixel & Conversion Tracking", description: description: "We will set up accurate tracking systems to measure performance and optimize campaigns. This gives you clear insight into what's working and what needs improvement.", price: "$400 one-time", pipelineStatus: "coming-soon" },
  { slug: "landing-page-review", category: "paid-advertising", name: "Landing Page Review", description: description: "We will analyze your landing pages to improve clarity, trust, and conversion rates. This ensures your ads lead to pages that actually drive results.", price: "$350 one-time", pipelineStatus: "coming-soon" },
  { slug: "google-ads-management", category: "paid-advertising", name: "Google Ads Management", description: description: "We will run high‑intent search campaigns designed to capture demand and drive conversions. This service unlocks once client accounts and credentials are verified.", price: "From $1,000/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "tiktok-ads-management", category: "paid-advertising", name: "TikTok Ads Management", description: description: "We will create short‑form video ads optimized for reach, engagement, and conversions. This helps your brand tap into TikTok's massive organic and paid potential.", price: "From $1,200/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "linkedin-ads-management", category: "paid-advertising", name: "LinkedIn Ads Management", description: description: "We will build professional B2B ad campaigns targeting decision‑makers and industry professionals. This positions your brand in front of high‑value audiences.", price: "From $1,200/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "x-ads-management", category: "paid-advertising", name: "X (Twitter) Ads Management", description: description: "We will run targeted ad campaigns built for real‑time engagement and visibility. This helps your brand stay relevant in fast‑moving conversations.", price: "From $1,000/month + 10% ad spend", pipelineStatus: "coming-soon" },
  { slug: "youtube-ads-management", category: "paid-advertising", name: "YouTube Ads Management", description: description: "We will create video‑based ad campaigns engineered to increase brand awareness and drive action. This service unlocks once client accounts are fully credentialed.", price: "From $1,200/month + 10% ad spend", pipelineStatus: "coming-soon" },

  // Social Strategy
  { slug: "social-media-audit-strategy", category: "social-strategy", name: "Social Media Audit", description: description: "We evaluate your entire social presence to identify what's working and what's holding you back. You receive a clear roadmap for improving growth and engagement.", price: "$500 one-time", pipelineStatus: "verified" },
  { slug: "competitor-analysis", category: "social-strategy", name: "Competitor Analysis", description: description: "We analyze your competitors' content, ads, and engagement to uncover opportunities and advantages. This helps you position your brand more effectively.", price: "$750 one-time", pipelineStatus: "verified" },
  { slug: "social-media-strategy", category: "social-strategy", name: "Social Media Strategy", description: description: "We build a complete strategy outlining how your brand should show up online to maximize growth. Every recommendation is tailored to your goals and audience.", price: "From $1,200 one-time", pipelineStatus: "verified" },
  { slug: "content-strategy", category: "social-strategy", name: "Content Strategy", description: description: "We create a structured plan for what to post, why it matters, and how it supports your business goals. This ensures your content is purposeful and effective.", price: "From $1,000 one-time", pipelineStatus: "verified" },
  { slug: "campaign-strategy", category: "social-strategy", name: "Campaign Strategy", description: description: "We design clear, actionable campaign plans that drive engagement and conversions. Each campaign is built to support your brand's long‑term growth.", price: "From $800 one-time", pipelineStatus: "verified" },
  { slug: "audience-research", category: "social-strategy", name: "Audience Research", description: description: "We study your ideal audience — demographics, interests, behaviors, and motivations. This helps you create content that resonates and converts.", price: "From $600 one-time", pipelineStatus: "verified" },
  { slug: "organic-growth-strategy", category: "social-strategy", name: "Organic Growth Strategy", description: description: "We develop a long‑term plan for increasing followers, engagement, and reach without paid ads. This builds sustainable, authentic growth.", price: "From $700/month", pipelineStatus: "verified" },
  { slug: "monthly-strategy-reviews", category: "social-strategy", name: "Monthly Strategy Reviews", description: description: "We review your performance monthly to refine your strategy and keep your growth on track. This ensures your approach evolves with your audience.", price: "From $500/month", pipelineStatus: "verified" },

  // Analytics & Reporting
  { slug: "monthly-performance-reports", category: "analytics-reporting", name: "Monthly Performance Reports", description: description: "We will deliver detailed monthly reports that highlight trends, wins, and opportunities. This gives you a clear understanding of your growth and performance.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "weekly-performance-summaries", category: "analytics-reporting", name: "Weekly Performance Summaries", description: description: "We will send concise weekly updates that keep you informed and aligned. This ensures you always know how your content is performing.", price: "From $350/month", pipelineStatus: "coming-soon" },
  { slug: "kpi-dashboard-setup", category: "analytics-reporting", name: "KPI Dashboard Setup", description: description: "We will build a custom dashboard showing your most important metrics in real time. This helps you make smarter, faster decisions.", price: "$750 one-time", pipelineStatus: "coming-soon" },
  { slug: "executive-reports", category: "analytics-reporting", name: "Executive Reports", description: description: "We will create high‑level reports designed for leadership and decision‑makers. These reports highlight strategic insights and business impact.", price: "From $600/month", pipelineStatus: "coming-soon" },
  { slug: "competitor-benchmarking", category: "analytics-reporting", name: "Competitor Benchmarking", description: description: "We will compare your performance against top competitors to identify strengths and opportunities. This helps you stay competitive and informed.", price: "From $500/month", pipelineStatus: "coming-soon" },

  // Community Management
  { slug: "community-management", category: "community-management", name: "Community Management", description: description: "We will oversee your community to strengthen relationships and improve brand loyalty. This ensures your audience feels supported and engaged.", price: "From $1,200/month", pipelineStatus: "coming-soon" },
  { slug: "daily-monitoring-engagement", category: "community-management", name: "Daily Monitoring & Engagement", description: description: "We will interact with your audience daily to keep your community active and responsive. This builds trust and improves algorithm performance.", price: "From $600/month", pipelineStatus: "coming-soon" },
  { slug: "comment-dm-response", category: "community-management", name: "Comment & DM Response", description: description: "We will respond to comments and messages quickly and professionally. This improves customer experience and builds stronger relationships.", price: "From $400/month", pipelineStatus: "coming-soon" },
  { slug: "review-management", category: "community-management", name: "Review Management", description: description: "We will monitor and respond to reviews to protect and strengthen your reputation. This helps you maintain trust and credibility.", price: "From $350/month", pipelineStatus: "coming-soon" },
  { slug: "social-listening-community", category: "community-management", name: "Social Listening", description: description: "We will track conversations around your brand to identify opportunities and feedback. This helps you stay ahead of trends and customer needs.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "influencer-research", category: "community-management", name: "Influencer Research", description: description: "We will identify influencers aligned with your brand for future collaborations. This helps you expand reach and credibility.", price: "From $750/month", pipelineStatus: "coming-soon" },
  { slug: "community-engagement-templates", category: "community-management", name: "Community Engagement Templates", description: description: "We will create pre‑built engagement templates to streamline communication. This ensures consistent, professional interactions.", price: "$300 one-time", pipelineStatus: "coming-soon" },
  { slug: "platform-setup-community", category: "community-management", name: "Platform Setup & Optimization", description: description: "We will set up and optimize community‑focused tools and features. This improves workflow and audience experience.", price: "From $750 one-time", pipelineStatus: "coming-soon" },
  { slug: "social-inbox-management", category: "community-management", name: "Social Inbox Management", description: description: "We will manage your inbox to ensure faster responses and better organization. This improves customer satisfaction and lead capture.", price: "From $500/month", pipelineStatus: "coming-soon" },
  { slug: "social-inbox-design", category: "community-management", name: "Social Inbox Design", description: description: "We will design a structured, optimized inbox layout that improves workflow and response efficiency. This helps your team stay organized and effective.", price: "From $600 one-time", pipelineStatus: "coming-soon" },
];

// Category descriptions for service filtering
export const categoryDescriptions: Record<string, string> = {
  "organic-content": "We create high‑quality, platform‑ready content engineered to strengthen your brand, increase engagement, and keep your business consistently visible with a polished, professional presence.",
  "paid-advertising": "We build data‑driven advertising systems engineered to increase visibility, generate leads, and deliver measurable results across major ad platforms.",
  "social-strategy": "We develop clear, actionable strategies that guide your content, campaigns, and growth — giving your business a structured path to stronger results.",
  "analytics-reporting": "We provide clear, easy‑to‑understand reporting that shows exactly how your content and campaigns are performing — and where new opportunities exist.",
  "community-management": "We help you build stronger relationships with your audience through consistent engagement, monitoring, and community‑driven interactions.",
};
